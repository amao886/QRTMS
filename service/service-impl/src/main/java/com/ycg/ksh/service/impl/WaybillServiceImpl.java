	...
	public FileEntity listExportWaybill(JSONObject req) throws ParameterException, BusinessException {
        ...
        try {
            ...
            for (Waybill waybill : depotAlliances) {
                easyExcel.row(StringUtils.isNotBlank(waybill.getLoadTime()) ? DateUtils.formatDate(new Date(waybill.getLoadTime())) : "",waybill.getReceiverName(),waybill.getSimpleEndStation(),StringUtils.isNotBlank(waybill.getLoadNo())? waybill.getLoadNo():"",StringUtils.isNotBlank(waybill.getDeliveryNumber()) ? waybill.getDeliveryNumber() :"",waybill.getNumber(),waybill.getVolume()==null?0:waybill.getVolume(),
