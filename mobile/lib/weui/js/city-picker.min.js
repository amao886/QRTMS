var all_city_data = null;

function loadData(_all_city_data) {
	all_city_data = _all_city_data;
}
		...
		var a = all_city_data,
			...
			d = function(e, n) {
				for(var c1 = 0; c1 < a.length; c1++)
					if(a[c1].code === e || a[c1].name === e)
						for(var m = 0; m < a[c1].sub.length; m++)
							if(a[c1].sub[m].code === n || a[c1].sub[m].name === n) return o(a[c1].sub[m])
			},
			u = function(e) {
				var n, c, o = a[0],
					m = e.split(" ");
