...
//			$("#deliveryTime").mobiscroll($.extend(opt['datetime'], opt['default']));
		...
		chooseCustomer: function(type) {
			...
			window.location.href = _common.version('../choosecustomer/chooseCustomer.html?type=' + type + "&role=carrier&isInputPlanPage=false&planKey=" + _common.getUrlParam('planKey'));
		},
		chooseAddress: function() {
			...
			window.location.href = _common.version('../choosedeliveryaddress/chooseDeliveryAddress.html?role=carrier&isInputPlanPage=false&planKey=' + _common.getUrlParam('planKey'));
		},
		saveData: function() {
			var _this = this;
