var inputPlan = new Vue({
	...
	methods: {
		...
		chooseCustomer: function(type) {
			...
			window.location.href = _common.version('../choosecustomer/chooseCustomer.html?type=' + type + "&role=shipper&isInputPlanPage=true");
		},
		chooseAddress: function() {
			...
			window.location.href = _common.version('../choosedeliveryaddress/chooseDeliveryAddress.html?role=shipper&isInputPlanPage=true');
		},
		saveData: function() {
			var _this = this;
