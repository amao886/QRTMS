			...
			render: function() {
				...
				EasyAjax.ajax_Post_Json({
					...
					if(res.success) {
						...
						_this.baseInformation.contractType = res.result.contractType;
...
//				if(!reg.test(parmas.customerCode)) {
//					_common.toast(3, '客户编码为数字,字母或者特殊符号')
//					return false
//				}
//				if(parmas.customerCode == '' || parmas.customerCode == null) {
//					_common.toast(3, '客户编码不能为空')
//					return false
//				}
