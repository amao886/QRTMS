    ...
    $.fn.extend({
        uploadImage: function(options){
            ...
            var tempHtml = "<div class='uploadimg-context'>" +
                "<div class='uploadimg-file-div'><input type='file' title='请选择图片' class='uploadimg-file-input' multiple accept='image/png,image/jpg,image/gif,image/JPEG'/>点击选择图片</div>" +
