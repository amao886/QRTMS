...
<div class="track-content">
    <form id="shipper-manage-form" action="${basePath}/enterprise/order/receipt/receirve/search" method="get">
        ...
        <template>
            ...
            <table>
                ...
                <tr v-for="(o, index) in collection" v-if="collection.length > 0">
                    ...
                    <td>
                        <span v-if="o.receiptFettle >= 3">已签</span>
                        <span v-else>未签</span>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <a class="linkBtn" v-if="o.receiptFettle == 3 || o.receiptFettle == 1" @click="sign(o.id)">签署</a>&nbsp;&nbsp;
                    </td>
                </tr>
                </tbody>
            </table>
        ...
        <div class="pancelCon clearfix">
            ...
            <div class="clearfix">
                <div class="abnormalSign">
                    <p v-if="exception != null"> 异常:{{exception.content}} </p>
                </div>
                <!--
    ...
    $(document).ready(function () {
        ...
        function batchSign(vm) {
            ...
            for(var i = 0; i < selects.length; i++){
                ...
                if(comparison == null){
                    comparison = o.convey.id;
                }else if(comparison - o.convey.id != 0){
                    result = false;
                    break;
                }
                keys.push(o.id);
            ...
            validate(function(){
                if(!result){
                    $.util.confirm('操作警告', '选中的回单中存在不同物流商，请问是否继续批量签署?', function () {
                        window.location.href= base_url + '/enterprise/sign/view/multiple?rt=3&orderKeys='+ keys.join(',');
                    });
                }else{
                    window.location.href= base_url + '/enterprise/sign/view/multiple?rt=3&orderKeys='+ keys.join(',');
                }
