...
<body data-key="${key}" data-identification="${identification}">
<!-- 让IE8/9支持媒体查询，从而兼容栅格 -->
<!--[if lt IE 9]>
                ...
                <div class="text-tag two">
                    ...
                    <p class="p-tag">
                        <el-autocomplete class="inline-input" v-model="order.shipperName" placeholder="请输入内容"
                                         ...
                                         @select="handleSelect" @focus="customerType = 1">
                        </el-autocomplete>
                    </p>
                </div>
                ...
                <div class="text-tag two">
                    ...
                    <p class="p-tag">
                        <el-autocomplete class="inline-input" v-model="order.conveyName" placeholder="请输入内容"
                                         :fetch-suggestions="querySearch" :trigger-on-focus="false"
                                         @select="handleSelect" @focus="customerType = 3">
                        </el-autocomplete>
                    </p>
                </div>
                <div class="text-tag two">
                ...
                <div class="text-tag two">
                    ...
                    <p class="p-tag">
                        <el-autocomplete class="inline-input" v-model="order.receiveName" placeholder="请输入内容"
                                         :fetch-suggestions="querySearch" :trigger-on-focus="false"
                                         @select="handleSelect" @focus="customerType = 2">
                        </el-autocomplete>
                    </p>
                </div>
        ...
        new Vue({
            ...
            methods: {
                ...
                handleSelect: function (item) {
                    var _this = this;
                    console.log(_this.customerType +"----------"+ item);
                ...
                submitSomething:function(){
                    ...
                    var parmas = {
                     ...
                     if(_this.identification === 1){
                         //1表示承运商生成发货单
                         //0表示发货方生成发货单
                         $.util.json("/enterprise/plan/shipper/generate/order", parmas, function (data) {
                             if (data.success) {
                         ...
                         $.util.json("/enterprise/plan/coveyer/generate/order", parmas, function (data) {
                             if (data.success) {
                                 $.util.success(data.message, function(){
                                     if(parent.layer){
                                         parent.layer.close(parent.layer.getFrameIndex(window.name));
