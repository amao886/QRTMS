...
<div class="complaint-record" id="complaint-record">
    <template>
        <div class="search">
            <el-input v-model="search.likeString" placeholder="送货单号/发货方"></el-input>
        ...
        <div class="content">
            <el-table :data="list" style="width: 100%" height="450" border="true" @selection-change="handleSelectChange" fit>
                <el-table-column type="selection" ></el-table-column>
                <el-table-column fixed  prop='order.deliveryNo' label="送货单号"  align="center" width='200'></el-table-column>
                <el-table-column fixed prop="shipperName" label="发货方" align="center" show-overflow-tooltip  width='150'></el-table-column>
                <el-table-column prop="complainantContent" label="投诉内容"  align="center" show-overflow-tooltip ></el-table-column>
                <el-table-column label="投诉时间"  align="center" show-overflow-tooltip width='150'>
