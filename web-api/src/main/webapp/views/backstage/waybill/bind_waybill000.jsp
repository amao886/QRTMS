                    ...
                    <div class="barcode-list" style="min-height: 167px;">
                        <div class="table-style">
                            <table>
                                ...
                                <tbody id="fristTBody">
                                <tr v-for="item in codes" v-bind:id="item.barcode" v-on:click="select(item.barcode)">
                                    <td>{{ item.barcode }}</td>
                                    <td>{{ item.loadTime }}</td>
                                </tr>
                                </tbody>
                    ...
                    <div class="barcode-list" style="min-height: 167px;">
                        <div class="table-style">
                            <table>
                                ...
                                <tbody id="goods_list">
                                <tr  v-for="item in waybills" v-bind:id="item.id" v-on:click="select(item.id)">
...
<script>
    $(document).ready(function () {
        ...
        var v = {
            detailCode : new Vue({
                el: '#detail-wait-code',
                data:{ barcode: null, loadTime: null, loader: {}, images: [], tracks: [] },
                computed: {
                    imgs: function () {
                        var imgs = [];
                ...
                mounted: function () {
                   // console.log($('img'));
                    this.$nextTick(function () {
                        console.log(ss.$el.getElementsByTagName('img')[0].src);
                    })
                }
            }),
            listCode : new Vue({
                ...
                methods:{
                    ...
                    search:function(event){ this.listCode(1); },
                    page: function(num){ this.listCode(num); },
        ...
        $('#done-bind').on('click', function(){
            ...
            if(!deliveryNumber.html()){
                ...
                $.util.form('输入送货单号', html, null, function () {
                    ...
                    var deliveryVal = editBody.find("input").val();
                    if (!deliveryVal) {
                        $.util.error("请输入送货单号");
                        return false;
                    }
