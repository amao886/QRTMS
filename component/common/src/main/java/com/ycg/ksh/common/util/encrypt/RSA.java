...
public class RSA {
    ...
    public static String sign(String content, String privateKey,String input_charset) throws Exception {
        String charset = isEmpty(input_charset)?ENCODING : input_charset;
    ...
    public static void main(String[] args) throws Exception {
        ...
        Globallys.initializeIDBuilder("10.133.12.53");
        System.out.println("KEY: "+ Globallys.nextKey());

        System.out.println("PrivateKey: "+ RSA.getPrivateKey(keys));
        System.out.println("PublicKey: "+ RSA.getPublicKey(keys));
    }
