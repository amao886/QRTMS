 ...
 */
public class DriverCar extends Model {
    ...
    public DriverCar(Integer type, Float length, Float loadValue, String license) {
        this.setType(type);
    ...
    public DriverCar(Long driverKey, Integer type, Float length, Float loadValue, String license) {
    ...
    public DriverCar modify(Long driverKey){
        return new DriverCar(driverKey, type, length, loadValue, license);
    }
