 ...
 */
public class DriverRoute extends Model {
    ...
    public DriverRoute(Integer type, String start, String end) {
    ...
    public DriverRoute(Long driverKey, Integer type, String start, String end) {
        this.setDriverKey(driverKey);
        this.setType(type);
        this.setStart(start);
        this.setEnd(end);
    }
    public DriverRoute modify(Long driverKey){
        return new DriverRoute(driverKey, type, start, end);
    }
    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof DriverRoute)) return false;
        DriverRoute that = (DriverRoute) o;
