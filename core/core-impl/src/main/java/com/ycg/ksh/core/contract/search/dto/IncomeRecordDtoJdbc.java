...
public class IncomeRecordDtoJdbc extends BaseEntity {
    ...
    public IncomeRecordDtoJdbc() {
    }

    public IncomeRecordDtoJdbc(String deliveryNo, LocalDateTime deliveryDate) {
        this.deliveryDate = deliveryDate;
        this.deliveryNo = deliveryNo;
    }

    public IncomeRecordDtoJdbc(Long systemId, double transportReceivable, double otherTotalReceivable, String otherReceivableRemark) {
